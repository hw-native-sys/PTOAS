...
//===- PTOCommon.h - Common PTO IR declarations --------------*- C++ -*-===//
//===----------------------------------------------------------------------===//
//
// This file owns dialect declarations shared by PTO operation families.
// Operation classes belong in family headers; PTO.h remains the compatibility
// aggregate for clients that need every operation.
//
//===----------------------------------------------------------------------===//

#ifndef MLIR_DIALECT_PTO_IR_PTOCOMMON_H_
#define MLIR_DIALECT_PTO_IR_PTOCOMMON_H_
...
#endif // MLIR_DIALECT_PTO_IR_PTOCOMMON_H_
