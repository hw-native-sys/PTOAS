...
本页是类型系统部分的总入口。各具体类型的细分说明参见下列四个子页。

## 文档索引

- [元素类型](./element_types.md)
- [指针类型](./pointer_types.md)
- [Tensor View 类型](./tensor_view_types.md)
- [Tile Buffer 类型](./tile_buffer_types.md)
...
- `f8E4M3FN`、`f8E5M2`
- `!pto.hif8`、`!pto.f8E8M0`
- `!pto.hif8x2`、`!pto.f4E1M2x2`、`!pto.f4E2M1x2`

详见：[元素类型](./element_types.md)

### 指针类型

`!pto.ptr<T>` 表示全局内存入口，是很多 PTO 程序的外部输入边界。

详见：[指针类型](./pointer_types.md)
...
详见：[Tensor View 类型](./tensor_view_types.md)

### Tile 与 Tile Buffer 类型
...
详见：[Tile Buffer 类型](./tile_buffer_types.md)
...
- 某些类型主要用于特定使用场景，公开使用时应以本手册的约束和示例为准
