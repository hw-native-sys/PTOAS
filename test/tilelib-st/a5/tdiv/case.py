...
"""PTODSL ST coverage for the A5 int32 soft implementation of ``tdiv``."""
...
@pto.jit(name="tdiv_i32_soft_1x64_reciprocal", target="a5")
def _kernel(
...
def _make_inputs():
    ...
    rhs = np.resize(rhs_values, (ROWS, COLS))
    return [lhs, rhs]


CASES = [
    golden_output_case(
        "tdiv_i32_soft_1x64_reciprocal",
        _kernel,
        inputs=_make_inputs,
