...
void LaunchVmi_quant_bf16x2_to_f4x2_full_kernel(uint16_t *src, uint8_t *dst,
                                                void *stream);

int main() {
  constexpr size_t kSrcElems = 512;   // bf16 (256 bf16x2 pairs)
  constexpr size_t kDstElems = 256;   // f4x2 (1 byte per pair)
  ...
  LaunchVmi_quant_bf16x2_to_f4x2_full_kernel(srcDevice, dstDevice, stream);
