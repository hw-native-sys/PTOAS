...
void LaunchVmi_quant_bf16x2_to_f4x2_rounding_kernel(uint16_t *src, uint8_t *dst,
                                                    void *stream);

int main() {
  constexpr size_t kSrcElems = 384;   // bf16 (3 chunks of 128)
  constexpr size_t kDstElems = 192;   // f4x2 (3 regions of 64)
  ...
  LaunchVmi_quant_bf16x2_to_f4x2_rounding_kernel(srcDevice, dstDevice, stream);
