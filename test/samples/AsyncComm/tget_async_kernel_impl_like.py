...
def _build_async_session(scratch, workspace, i32, sync_id=0):
    ...
    op = Operation.create(
        ...
        results=[Type.parse("!pto.async_session")],
    )
    return op.result


def _tget_async(dst, src, session):
    ...
    op = Operation.create(
        ...
        results=[Type.parse("!pto.async_event")],
    )
    return op.result
        ...
        with Location.unknown(ctx):
            ...
            with InsertionPoint(entry):
                ...
                with InsertionPoint(valid_if.then_block):
                    ...
                    session = _build_async_session(scratch, workspace, i32, sync_id=0)
                        ...
                        with InsertionPoint(loop.body):
                            ...
                            with InsertionPoint(target_if.then_block):
                                ...
                                with InsertionPoint(rank1_if.then_block):
                                    event1 = _tget_async(dst_rank1, src_rank1, session)
                                ...
                                with InsertionPoint(rank2_if.then_block):
                                    event2 = _tget_async(dst_rank2, src_rank2, session)
                                ...
                                with InsertionPoint(rank3_if.then_block):
                                    event3 = _tget_async(dst_rank3, src_rank3, session)
