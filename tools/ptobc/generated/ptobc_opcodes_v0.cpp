...
static uint16_t lookupOpcodeByNameChunk1(llvm::StringRef name) {
  return llvm::StringSwitch<uint16_t>(name)
...
static uint16_t lookupOpcodeByNameChunk2(llvm::StringRef name) {
  return llvm::StringSwitch<uint16_t>(name)
...
static uint16_t lookupOpcodeByNameChunk3(llvm::StringRef name) {
  return llvm::StringSwitch<uint16_t>(name)
...
static uint16_t lookupOpcodeByNameChunk4(llvm::StringRef name) {
  return llvm::StringSwitch<uint16_t>(name)
...
static uint16_t lookupOpcodeByNameChunk5(llvm::StringRef name) {
  return llvm::StringSwitch<uint16_t>(name)
...
static uint16_t lookupOpcodeByNameChunk6(llvm::StringRef name) {
  return llvm::StringSwitch<uint16_t>(name)
...
static uint16_t lookupOpcodeByNameChunk7(llvm::StringRef name) {
  return llvm::StringSwitch<uint16_t>(name)
...
static uint16_t lookupOpcodeByNameChunk8(llvm::StringRef name) {
  return llvm::StringSwitch<uint16_t>(name)
...
static uint16_t lookupOpcodeByNameChunk9(llvm::StringRef name) {
  return llvm::StringSwitch<uint16_t>(name)
...
static uint16_t lookupOpcodeByNameChunk10(llvm::StringRef name) {
  return llvm::StringSwitch<uint16_t>(name)
...
std::optional<uint16_t> lookupOpcodeByName(llvm::StringRef name) {
  if (uint16_t v = lookupOpcodeByNameChunk1(name); v != 0xFFFF)
    return v;
  if (uint16_t v = lookupOpcodeByNameChunk2(name); v != 0xFFFF)
    return v;
  if (uint16_t v = lookupOpcodeByNameChunk3(name); v != 0xFFFF)
    return v;
  if (uint16_t v = lookupOpcodeByNameChunk4(name); v != 0xFFFF)
    return v;
  if (uint16_t v = lookupOpcodeByNameChunk5(name); v != 0xFFFF)
    return v;
  if (uint16_t v = lookupOpcodeByNameChunk6(name); v != 0xFFFF)
    return v;
  if (uint16_t v = lookupOpcodeByNameChunk7(name); v != 0xFFFF)
    return v;
  if (uint16_t v = lookupOpcodeByNameChunk8(name); v != 0xFFFF)
    return v;
  if (uint16_t v = lookupOpcodeByNameChunk9(name); v != 0xFFFF)
    return v;
  if (uint16_t v = lookupOpcodeByNameChunk10(name); v != 0xFFFF)
    return v;
  return std::nullopt;
}
...
static std::optional<OpcodeAndVariant>
lookupOpcodeAndVariantByFullNameChunk1(llvm::StringRef fullName) {
...
static std::optional<OpcodeAndVariant>
lookupOpcodeAndVariantByFullNameChunk2(llvm::StringRef fullName) {
  return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
...
static std::optional<OpcodeAndVariant>
lookupOpcodeAndVariantByFullNameChunk3(llvm::StringRef fullName) {
  return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
...
static std::optional<OpcodeAndVariant>
lookupOpcodeAndVariantByFullNameChunk4(llvm::StringRef fullName) {
  return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
...
static std::optional<OpcodeAndVariant>
lookupOpcodeAndVariantByFullNameChunk5(llvm::StringRef fullName) {
  return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
...
static std::optional<OpcodeAndVariant>
lookupOpcodeAndVariantByFullNameChunk6(llvm::StringRef fullName) {
  return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
...
static std::optional<OpcodeAndVariant>
lookupOpcodeAndVariantByFullNameChunk7(llvm::StringRef fullName) {
  return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
...
static std::optional<OpcodeAndVariant>
lookupOpcodeAndVariantByFullNameChunk8(llvm::StringRef fullName) {
  return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
...
static std::optional<OpcodeAndVariant>
lookupOpcodeAndVariantByFullNameChunk9(llvm::StringRef fullName) {
  return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
...
static std::optional<OpcodeAndVariant>
lookupOpcodeAndVariantByFullNameChunk10(llvm::StringRef fullName) {
  return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
...
static std::optional<OpcodeAndVariant>
lookupOpcodeAndVariantByFullNameChunk11(llvm::StringRef fullName) {
  return llvm::StringSwitch<std::optional<OpcodeAndVariant>>(fullName)
...
std::optional<OpcodeAndVariant> lookupOpcodeAndVariantByFullName(llvm::StringRef fullName) {
  ...
  if (auto result = lookupOpcodeAndVariantByFullNameChunk1(fullName))
    return result;
  if (auto result = lookupOpcodeAndVariantByFullNameChunk2(fullName))
    return result;
  if (auto result = lookupOpcodeAndVariantByFullNameChunk3(fullName))
    return result;
  if (auto result = lookupOpcodeAndVariantByFullNameChunk4(fullName))
    return result;
  if (auto result = lookupOpcodeAndVariantByFullNameChunk5(fullName))
    return result;
  if (auto result = lookupOpcodeAndVariantByFullNameChunk6(fullName))
    return result;
  if (auto result = lookupOpcodeAndVariantByFullNameChunk7(fullName))
    return result;
  if (auto result = lookupOpcodeAndVariantByFullNameChunk8(fullName))
    return result;
  if (auto result = lookupOpcodeAndVariantByFullNameChunk9(fullName))
    return result;
  if (auto result = lookupOpcodeAndVariantByFullNameChunk10(fullName))
    return result;
  if (auto result = lookupOpcodeAndVariantByFullNameChunk11(fullName))
    return result;
  return std::nullopt;
}
