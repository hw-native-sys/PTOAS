...
getFloatPredicate(pto::ScalarCmpPredicate predicate) {
  struct Entry {
    pto::ScalarCmpPredicate predicate;
    arith::CmpFPredicate comparison;
  };
  static constexpr Entry entries[] = {
      {pto::ScalarCmpPredicate::Eq, arith::CmpFPredicate::OEQ},
      {pto::ScalarCmpPredicate::Ne, arith::CmpFPredicate::ONE},
      {pto::ScalarCmpPredicate::Lt, arith::CmpFPredicate::OLT},
      {pto::ScalarCmpPredicate::Le, arith::CmpFPredicate::OLE},
      {pto::ScalarCmpPredicate::Gt, arith::CmpFPredicate::OGT},
      {pto::ScalarCmpPredicate::Ge, arith::CmpFPredicate::OGE},
      {pto::ScalarCmpPredicate::AlwaysFalse, arith::CmpFPredicate::AlwaysFalse},
      {pto::ScalarCmpPredicate::OEq, arith::CmpFPredicate::OEQ},
      {pto::ScalarCmpPredicate::OGt, arith::CmpFPredicate::OGT},
      {pto::ScalarCmpPredicate::OGe, arith::CmpFPredicate::OGE},
      {pto::ScalarCmpPredicate::OLt, arith::CmpFPredicate::OLT},
      {pto::ScalarCmpPredicate::OLe, arith::CmpFPredicate::OLE},
      {pto::ScalarCmpPredicate::ONe, arith::CmpFPredicate::ONE},
      {pto::ScalarCmpPredicate::Ord, arith::CmpFPredicate::ORD},
      {pto::ScalarCmpPredicate::UEq, arith::CmpFPredicate::UEQ},
      {pto::ScalarCmpPredicate::UGt, arith::CmpFPredicate::UGT},
      {pto::ScalarCmpPredicate::UGe, arith::CmpFPredicate::UGE},
      {pto::ScalarCmpPredicate::ULt, arith::CmpFPredicate::ULT},
      {pto::ScalarCmpPredicate::ULe, arith::CmpFPredicate::ULE},
      {pto::ScalarCmpPredicate::UNe, arith::CmpFPredicate::UNE},
      {pto::ScalarCmpPredicate::Uno, arith::CmpFPredicate::UNO},
      {pto::ScalarCmpPredicate::AlwaysTrue, arith::CmpFPredicate::AlwaysTrue},
  };
