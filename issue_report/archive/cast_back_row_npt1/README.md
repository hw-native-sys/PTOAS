...
TMA leftover mismatches (TMA npt=1 H=2048 and e2m1→fp32 TMA npt=32 H=2048) are likewise kernel-fixed for correctness (`benchfix_0911` / `5b4bb1f3d`) and stay **TODO(perf)** — see sibling archive dirs. Old issue **A** is withdrawn ([`vmi_1xT_ue8m0_scale_apply`](../vmi_1xT_ue8m0_scale_apply/)).
