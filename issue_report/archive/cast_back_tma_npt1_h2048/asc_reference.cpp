...
__simd_vf__ inline void cast_back_kernel_ascend_kernel_simd_vf_0(__ubuf__ uint8_t* buf_dyn_shmem, int32_t sf_raw_ub_version_counter_1) {
  ...
  for (int32_t group = 0; group < 48; ++group) {
    for (int32_t chunk = 0; chunk < 8; ++chunk) {
      auto packed = simd_inst::vlds_brc_elem<uint16_t>((__ubuf__ uint16_t*)(&(((__ubuf__ uint16_t*)buf_dyn_shmem)[((((((3 & ((sf_raw_ub_version_counter_1 % 3) >> 31)) * 384) + ((sf_raw_ub_version_counter_1 % 3) * 384)) + (chunk * 48)) + group) + 36864)])), 0);
      ...
      simd_inst::vsts_pack_b32(out_bf16, (__ubuf__ bfloat16_t*)(&(((__ubuf__ bfloat16_t*)buf_dyn_shmem)[((((((3 & ((sf_raw_ub_version_counter_1 % 3) >> 31)) * 24576) + ((sf_raw_ub_version_counter_1 % 3) * 24576)) + (group * 512)) + (chunk * 64)) + 38016)])), 0, v_2);
    }
  }
}
...
extern "C" __global__ __vector__ void cast_back_kernel_ascend_kernel(__gm__ bfloat16_t* out, __gm__ fp8_e4_t* x, __gm__ uint16_t* x_sf, int32_t num_tokens, int32_t sf_stride) {
  ...
  for (int32_t w = 0; w < ((num_tokens + 863) / 864); ++w) {
    ...
    if (((w * 72) + ((int32_t)block_idx)) < ((((num_tokens + 47) / 48) * 4) + ((((num_tokens + 47) % 48) >> 31) * 4))) {
      source = x_sf[(((((int64_t)w) * (int64_t)864) + ((((int64_t)((int32_t)block_idx)) / (int64_t)4) * (int64_t)48)) + (((((int64_t)((int32_t)block_idx)) % (int64_t)4) * ((int64_t)sf_stride)) * (int64_t)8))];
      ...
      asc_copy_gm2ub_align((__ubuf__ uint8_t*)((&(((__ubuf__ uint16_t*)buf_dyn_shmem)[((((3 & ((sf_raw_ub_version_counter_1 % 3) >> 31)) * 384) + ((sf_raw_ub_version_counter_1 % 3) * 384)) + 36864)]))), (__gm__ uint8_t*)((&(x_sf[(((((int64_t)w) * (int64_t)864) + ((((int64_t)((int32_t)block_idx)) / (int64_t)4) * (int64_t)48)) + (((((int64_t)((int32_t)block_idx)) % (int64_t)4) * ((int64_t)sf_stride)) * (int64_t)8))]))), 8, (min(48, max(((num_tokens - ((((int32_t)block_idx) / 4) * 48)) - (w * 864)), 0)) * 2), 0, 0, 0, static_cast<asc_load_l2_cache_mode>(0), (sf_stride * 2), 96);
      ...
      asc_copy_ub2gm_align((__gm__ uint8_t*)((&(out[(((((int64_t)w) * (int64_t)1769472) + ((((int64_t)((int32_t)block_idx)) / (int64_t)4) * (int64_t)98304)) + ((((int64_t)((int32_t)block_idx)) % (int64_t)4) * (int64_t)512))]))), (__ubuf__ uint8_t*)((&(((__ubuf__ bfloat16_t*)buf_dyn_shmem)[((((3 & ((sf_raw_ub_version_counter_1 % 3) >> 31)) * 24576) + ((sf_raw_ub_version_counter_1 % 3) * 24576)) + 38016)]))), min(48, max(((num_tokens - ((((int32_t)block_idx) / 4) * 48)) - (w * 864)), 0)), 1024, static_cast<asc_store_l2_cache_mode>(4), 4096, 1024);
