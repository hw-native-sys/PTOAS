# cast_back e4m3→fp32 TMA npt=1 H=128

Production TileLang VMI for this leftover, recorded on PTOAS `b465f26b` / CANN 9.2.0 / A5.

## Bug pattern

ACL 507035 after PTODSL compile-OK (same legal 1×T pattern as npt=32)
...
PTODSL_COMPILE_OK then VMI_RUNTIME_ERROR ACL 507035 (isolated, 2026-09-09 device 1)
