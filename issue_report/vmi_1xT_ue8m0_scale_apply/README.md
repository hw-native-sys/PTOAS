...
|---|---|---|
| cast_back e4m3→fp32 TMA npt=32 H=128 | compile-OK, ACL 507035 | [`archive/cast_back_e4m3_fp32_tma_npt32_h128/`](../archive/cast_back_e4m3_fp32_tma_npt32_h128/) |
| cast_back e4m3→fp32 TMA npt=1 | compile-OK, ACL 507035 | [`archive/cast_back_e4m3_fp32_tma_npt1/`](../archive/cast_back_e4m3_fp32_tma_npt1/) |
| cast_back row npt=1 (e2m1/e4m3→bf16/fp32) | mismatch, or 507035 in a dirty session | [`archive/cast_back_row_npt1/`](../archive/cast_back_row_npt1/) |
| cast_back TMA npt=1 H=2048 e2m1/e4m3→bf16 | isolated mismatch 117550 / 124084 | [`archive/cast_back_tma_npt1_h2048/`](../archive/cast_back_tma_npt1_h2048/) |
| cast_back e2m1→fp32 TMA npt=32 H=2048 | isolated mismatch 81987 / 3.0 | [`archive/cast_back_e2m1_fp32_tma_npt32_h2048/`](../archive/cast_back_e2m1_fp32_tma_npt32_h2048/) |
