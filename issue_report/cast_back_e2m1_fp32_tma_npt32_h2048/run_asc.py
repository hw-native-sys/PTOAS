#!/usr/bin/env python3
"""Launch Nightly ASC cast_back for row-major npt=1 e4m3→bf16 512×2048."""
...
def main() -> int:
    ...
    x, sf = torch_cast(
        ...
        'e4m3', (1, 32), round_sf=True,
        use_tma_aligned_col_major_sf=False, use_packed_ue8m0=True,
    )
    in_cfg = get_cast_input_config_impl(torch.float8_e4m3fn, (1, 32), False, True)
    kn = nmod.get_cast_back_kernel_ascend(h, in_cfg, T.bfloat16, 72)
